            ...
            <c:forEach var="essay" items="${essayList}">
                <div class="media">
                    ...
                    <div class="media-left">
                        <img src="${pageContext.request.contextPath}/statics/UserDefaultPic/essayimg.jpg"
                    ...
                    <div class="media-body">
                        ...
                        <div class="tip">
                            <p class="gray">
                                <a style="text-align: left; display: inline-block; width: 25%;color: #000000">${essay.essayUserDisplayName}</a>
                                <span
                                        style="text-align: right; display: inline-block; width: 70%;"
                                ><fmt:formatDate
                                        value="${essay.essayCreateTime}"
