    ...
    <div class="row clearfix">
        ...
        <div class="row">
            <div class="col-md 4 column">
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/school/toAddSchool">新增学校</a>
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/essay/allEssay">显示全部论文</a>
